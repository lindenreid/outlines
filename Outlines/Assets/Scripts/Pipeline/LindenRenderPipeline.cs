...
namespace UnityEngine.Experimental.Rendering.LightweightPipeline
{
    ...
    {
        void ExecuteBeforeCameraRender(LindenRenderPipeline pipelineInstance, ScriptableRenderContext context, Camera camera);
    }

    public sealed partial class LindenRenderPipeline : RenderPipeline
    {
        ...
        private static IRendererSetup s_LindenDefaultRendererSetup;
        private static IRendererSetup lindenDefaultRendererSetup
        {
            get
            {
                if (s_LindenDefaultRendererSetup == null)
                    s_LindenDefaultRendererSetup = new LindenDefaultRendererSetup();

                return s_LindenDefaultRendererSetup;
            }
        }
        ...
        public LindenRenderPipeline(LightweightRenderPipelineAsset asset)
        {
...
#if UNITY_EDITOR
            LindenSceneViewDrawMode.ResetDrawMode();
#endif
        ...
        public static void RenderSingleCamera(LindenRenderPipeline pipelineInstance, ScriptableRenderContext context, Camera camera, ref CullResults cullResults, IRendererSetup setup = null)
        {
            ...
            using (new ProfilingSample(cmd, k_RenderCameraTag))
            {
                ...
                if (setupToUse == null)
                    setupToUse = lindenDefaultRendererSetup;
        ...
        static void SetSupportedRenderingFeatures()
        {
            ...
            LindenSceneViewDrawMode.SetupDrawMode();
#endif
        }
